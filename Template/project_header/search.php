<div class="filter-box">
    <form method="get" action="<?= $this->url->dir() ?>" class="search">
        ...
        <div class="dropdown">
            <a href="#" class="dropdown-menu dropdown-menu-link-icon" title="<?= $this->Category_labelHelper->CategoryLabel($project['id']) ?>"><i class="fa fa-tags fa-fw"></i><i class="fa fa-caret-down"></i></a>
            <ul>
                <li><a href="#" class="filter-helper" data-unique-filter="category:none"><?= $this->Category_labelHelper->CategoryLabelNegation($project['id']) ?></a></li>
